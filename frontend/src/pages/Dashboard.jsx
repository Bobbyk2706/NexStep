    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Link to="/assistant" className="group flex items-center gap-4 rounded-2xl border border-slate-200/70 bg-surface p-5 shadow-card transition hover:border-indigo-200">
          ...
          <div>
            <p className="font-display font-semibold text-ink">Ask the assistant</p>
            <p className="text-sm text-slate-500">Questions about exams, answered from your profile.</p>
          </div>
        </Link>
